...
public class swgun : Tile
{
    ...
    {
        if (_cooldownTimer > 0 || ammoCount <= 0)
        {
            return;
        }
    ...
    void UpdateTileNameWithAmmo()
    {
        string originalTileName = "Gun"; 
        tileName = originalTileName + " Ammo: " + ammoCount; 
    }
}
